...
Property.prototype.configure = function (config) {
  ...
  this.defaultValue = typeof config.defaultValue !== 'undefined' ? config.defaultValue : null;
...
Property.update = function (property, reload) {
  ...
  if (property.collate !== undefined) {
    promises.push(this.db.exec(prefix + 'COLLATE ' + property.collate));
  }
  if (property.readonly !== undefined) {
    promises.push(this.db.exec(prefix + 'READONLY ' + (property.readonly ? 'true' : 'false')));
  }
